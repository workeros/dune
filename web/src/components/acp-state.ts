import type { ModelDescription } from "./acp-model";
...
export type State = { conversation?: ModelDescription | null; pending?: number; operation_ref?: string; revision: number; ready: boolean; busy: string; session_id: string; cwd: string; can_list: boolean; can_load: boolean; error?: string; stop_reason?: string; permissions: Permission[]; list?: { sessions: { sessionId: string; cwd: string; title?: string }[]; nextCursor?: string } };
