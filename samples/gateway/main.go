...
// Run with DUNE_TOKEN and DUNE_TARGET; point fabricd and sdk.Dial at /api/v1/ws/tunnel.
package main
...
func run() error {
	...
	mux.Handle("GET /api/v1/ws/tunnel", tunnel.NewHandler(ctx, g, func(presented string) (gateway.BindingContext, gateway.ConnectionHandler, error) {
